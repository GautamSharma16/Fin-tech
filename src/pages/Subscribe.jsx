        ...
        <div className="application-layout">
          ...
          <section className="application-card">
            {step < 4 ? <>
              ...
              <div className="form-actions"><button type="button" className="outline-button" onClick={step === 1 ? saveAndExit : () => setStep(step - 1)}>{step === 1 ? (saved ? 'Progress Saved' : 'Save & Exit') : <><ArrowLeft size={16} /> Back: {steps[step - 2]}</>}</button><button type="button" className="solid-button" onClick={goNext}>{step === 3 ? 'Continue to Review' : `Next: ${steps[step]} `}<ArrowRight size={16} /></button></div>
